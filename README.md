...
[![PyPI version](https://badge.fury.io/py/smart-system-info.svg)](https://pypi.org/project/smart-system-info/)
...
```bash
pip install smart-system-info
```

## Quick Start

```python
from smart_system_info import info
...
from smart_system_info import batch
